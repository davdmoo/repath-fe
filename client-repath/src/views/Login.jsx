    ...
    <>
      ...
      >
        ...
        <div style={{ marginTop: '20px' }}>
          <span style={{ color: 'white' }}> Or login with google</span>{' '}
          <GoogleLogin clientId="471327112485-267mc9216cmhnf1k5fnhh6a3d6qdaccl.apps.googleusercontent.com" buttonText="Login" onSuccess={responseGoogle} onFailure={responseGoogle} cookiePolicy={'single_host_origin'} />
        </div>
      </div>
      {afterPostUser ? (
        <div>
