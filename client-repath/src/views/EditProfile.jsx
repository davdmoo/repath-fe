						...
						>
							...
							>
								<TextField
									...
									name="firstName" label="first name" variant="filled" size="small"></TextField>

								<TextField
									// value={editUserForm.lastName}
									onChange={changeEditUserInput}
									name="lastName" label="last name" variant="filled" size="small"></TextField>
								<Box
									sx={{
								...
								name="headerUrl" label="header background url" variant="filled" margin="normal" size="small"></TextField> */}
									<TextField
										...
										onChange={changeEditUserInput}
										name="username" label="username" variant="filled" margin="normal" size="small" />
									<TextField
										// value={editUserForm.phoneNumber}
										onChange={changeEditUserInput}
										name="phoneNumber" label="phone number" variant="filled" margin="normal" size="small" />
									<TextField
										// value={editUserForm.city}
										onChange={changeEditUserInput}
										name="city" label="city" variant="filled" margin="normal" size="small" />
								</Box>
								<Button
									type="submit"
									variant="contained"
